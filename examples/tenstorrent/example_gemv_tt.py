...
def main():
    ...
    has_wait = "cb_wait_front(cb_in0" in compute
    has_pop = "cb_pop_front(cb_in0" in compute
    has_reserve = "cb_reserve_back(cb_out0" in compute
    has_push = "cb_push_back(cb_out0" in compute
