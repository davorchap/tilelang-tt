...
// All CBIndex, 6 args
inline void matmul_tiles(tt::CBIndex cb_in0, tt::CBIndex cb_in1,
                         tt::CBIndex start0, tt::CBIndex start1,
                         tt::CBIndex dst_idx, bool accumulate = false) {}

// All uint32_t, 6 args
inline void matmul_tiles(uint32_t cb_in0, uint32_t cb_in1, uint32_t start0,
                         uint32_t start1, uint32_t dst_idx,
                         bool accumulate = false) {}

// Mixed: CBIndex CBs, uint32_t indices, 6 args
inline void matmul_tiles(tt::CBIndex cb_in0, tt::CBIndex cb_in1,
                         uint32_t start0, uint32_t start1, uint32_t dst_idx,
                         bool accumulate = false) {}
...
inline void matmul_tiles(tt::CBIndex cb_in0, tt::CBIndex cb_in1,
                         tt::CBIndex cb_in2, uint32_t arg4, uint32_t arg5) {
  // Just a stub to make buggy code compile
}

// Matrix multiplication initialization
inline void mm_init(tt::CBIndex cb_in0, tt::CBIndex cb_in1,
                    tt::CBIndex cb_out) {}
