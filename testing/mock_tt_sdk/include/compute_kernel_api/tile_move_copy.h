...
inline void noc_async_read_tile(uint32_t tile_id, uint32_t accessor_id, uint32_t l1_addr) {}
inline void noc_async_read(uint64_t src_addr, uint32_t dst_addr, uint32_t size) {}
inline void noc_async_read_barrier() {}

// Asynchronous NOC write operations
inline void noc_async_write_tile(uint32_t tile_id, uint32_t accessor_id, uint32_t l1_addr) {}
inline void noc_async_write(uint32_t src_addr, uint64_t dst_addr, uint32_t size) {}
inline void noc_async_write_barrier() {}

// Tile copy operations
inline void copy_tile(tt::CBIndex src_cb, uint32_t tile_idx, tt::CBIndex dst_cb) {}
