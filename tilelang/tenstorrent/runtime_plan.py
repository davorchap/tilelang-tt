...
from .attrs import (
    TT_CORE_GRID, TT_CORE_RANGES, TT_CORE_RANGE, TT_WORK_PARTITION, TT_LAYOUT_DESC,
...
def extract_runtime_plan(func: "tir.PrimFunc") -> Dict[str, Any]:
    ...
    return plan_dict(core_grid=grid, core_ranges=ranges, 
                     work_partition=work, layouts=layouts)
